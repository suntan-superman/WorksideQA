...
async function runWorkflow({ page, config, helpers }) {
  ...
  checks.push(await helpers.gotoPath(page, config, workflow.dashboardRoute || "/", { timeout: 25000 }));
  checks.push(await helpers.assertVisible(page, workflow.dashboardSelectors || ["body"], "workflow dashboard", { timeout: 15000 }));
